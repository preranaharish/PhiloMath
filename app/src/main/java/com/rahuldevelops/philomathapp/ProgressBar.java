...
public class ProgressBar extends AbsProgressBar {
    ...
    private void init(AttributeSet attrs){
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.progressBar1);
        startFillColor = a.getColor(R.styleable.progressBar1_startFillColor1, 0xffff0000);
        middleFillColor = a.getColor(R.styleable.progressBar1_middleFillColor1, 0xffff0000);
        endFillColor = a.getColor(R.styleable.progressBar1_endFillColor1, 0xffff0000);
        arrowPointColor = a.getColor(R.styleable.progressBar1_arrowPointColor1, 0xffffffff);
        a.recycle();
    }
