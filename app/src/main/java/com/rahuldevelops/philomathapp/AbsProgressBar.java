...
public class AbsProgressBar extends View {
    ...
    private void init(Context context, AttributeSet attrs){
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.absProgressBar1);
        progress = a.getInteger(R.styleable.absProgressBar1_progress1, 0);
        backgroundColor = a.getColor(R.styleable.absProgressBar1_backgroundColor1, 0xfff4f4f4);
        textColor = a.getColor(R.styleable.absProgressBar1_textColor1, 0xffffffff);
        maxProgress = a.getInteger(R.styleable.absProgressBar1_maxProgress1, 100);
