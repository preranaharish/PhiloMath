...
ArrayList<String> hotwordslist=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences prefs = splash.this.getSharedPreferences(currentTime, MODE_PRIVATE);
       wordsofthedaydone =prefs.getInt(currentTime,0);
        if(wordsofthedaydone==0){
